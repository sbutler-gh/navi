...
function updatePointsForNewPrompt() {
  ...
  $route_store = "";
          ...
          <div class="section-txt" id="map">
            ...
            <div style="display: none; position: default; z-index: 100; top: 0; margin: auto; background: black; color: white; padding: 20px; text-align: center;">
